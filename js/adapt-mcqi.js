define(function(require) {
    ...
    var Mcqi = QuestionView.extend({

        events: {
            'focus .mcqi-item input':'onItemFocus',
            'blur .mcqi-item input':'onItemBlur',
            'change .mcqi-item input':'onItemSelected',
            'keyup .mcqi-item input':'onKeyPress'
        },
